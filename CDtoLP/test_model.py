...
t0 = time.time()
img_rows, img_cols = 60,76
(x_train, y_train), (x_test, y_test) = loader.loaderPictures('/training/pictures/LP_quality')#mnist.load_data()
...
print('Loading model :')
t0 = time.time()
autoencoder = load_model('UtenCD.h5')
